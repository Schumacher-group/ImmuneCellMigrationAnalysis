...
"""
trajectory = pd.read_csv("/Users/danieltudor/Documents/Groups/Wood group/New Images from Luigi/MCR csv data/MCR_filtered_spots_all_new")
...
for i in range(len(Bins)):
    for j in range(len(Bins[0])):
        ...
        np.save(
            '../data/New_MCR_data/MCR_data{}{}_timebins_trajs_new-binning-finer'.format(
