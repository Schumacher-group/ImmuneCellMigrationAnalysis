...
post_prod = np.load('../data/Synthetic_Data/posterior_results_production_longer_time_space.npy', allow_pickle=True)
post_delta = np.load('../data/Synthetic_Data/posterior_results_delta_longer_time_space.npy', allow_pickle=True)
...
plot_posterior_distributions(post_prod, params_prod_name, 7,
                             reference = params_production, name='Production', save_fig=False)

plot_posterior_chains(post_prod, params_prod_name, name='Production', n_discards=6000, save_fig=False)
...
observed_bias_posterior_plots(25, 250, 10, 130, params_production, production, wound, true_model='production',
                              post_model='production', save_fig=False)
...
plot_posterior_distributions(post_delta, params_delta_name, 6,
                             reference = params_delta,name='Delta', save_fig=False)
plot_posterior_chains(post_delta, params_delta, name='Delta', n_discards=6000, save_fig=False)
plot_marginal_joint_dists(delta, params_delta_name, model='delta', save_fig=False)
observed_bias_posterior_plots(25, 250, 10, 130, params_production, delta, wound, true_model='production',
                              post_model='delta', save_fig=False)
