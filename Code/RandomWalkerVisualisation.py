...
fig, ax = plt.subplots(6, 5, figsize=(10, 10), sharex=True)
...
plt.savefig('/Users/danieltudor/Documents/ImmuneCellMigrationAnalysis/Images/PosterImages/WalkerPoster/Weavers_loc1.pdf')
"""
