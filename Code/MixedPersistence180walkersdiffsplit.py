...
X0s = np.random.uniform(-5, 5, size=(num_1, 2))
...
# these are the starting positions of the leukocytes. Size must be of the form (N, 2)
X0s = np.random.uniform(-5, 5, size=(num_2, 2))
...
np.save(f"../data/Mixed_persistence_accuracy/Yi_data_total_180tracks_none_mixed",
        EM_total)
